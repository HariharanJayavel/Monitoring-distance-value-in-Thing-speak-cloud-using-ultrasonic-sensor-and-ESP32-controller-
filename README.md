...
Step4 Copy the Channel ID and API key in the thingspeak and update in the program<br>
Step5 Execute your program to send the sensor value to ThingSpeak<br>
Step6 Check your ThingSpeak channel to verify that the sensor value has been updated<br>
# THEORY:
## Ultrasonic sensor:
The HC-SR04 is a type of ultrasonic sensor which uses sonar to find out the distance of the object from the sensor. It provides an outstanding range of non-contact detection with high accuracy & stable readings. It includes two modules like ultrasonic transmitter & receiver. This sensor is used in a variety of applications.
...
```
# CIRCUIT DIAGRAM:
<img src="https://github.com/user-attachments/assets/f8043982-af2a-460d-b185-d7f7174d8d62" alt="Description" width="720" height="480">
